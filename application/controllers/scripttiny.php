...
/* ********************************************
  ...
  author      : SSM
********************************************* */ 
class Scripttiny extends MX_Controller {
  ...
  public function scripttiny_mce(){
    return '
    <!-- TinyMCE -->
    <script type="text/javascript" src="'.base_url().'application/assets/tiny_mce/tiny_mce_src.js"></script>
