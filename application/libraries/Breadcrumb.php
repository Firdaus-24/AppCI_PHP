...
class Breadcrumb {
	 ...
	 *
	 */
	private $_divider 		= '<span class="divider"><i class="icon-angle-right arrow-icon"></i></span></li>';
	private $_tag_open 		= '<div class="breadcrumbs" id="breadcrumbs"><ul class="breadcrumb">';
		...
		if ($this->breadcrumbs) {
			...
			foreach ($this->breadcrumbs as $key => $crumb) {
				...
				// else add link and divider
					...
					$output .= '<li><a href="' . $crumb['href'] . '">' . $crumb['title'] . '</a>';
				}
			}
