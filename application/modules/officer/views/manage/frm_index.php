...
<ul class="nav nav-tabs">
  <li role="presentation" class="active"><a href="#">Manage Carusel</a></li>  
  <!--
...
-->
  <li role="presentation"><a href="<?php echo base_url();?>officer/manage/comment">Comment Manage</a></li>
  <li role="presentation"><a href="<?php echo base_url();?>officer/manage/txt_about">Manage About Us</a></li>
</ul>
<div class="container sub">
	...
	<div id="form_List">
			<table class="table table-bordered table-striped table-fixed-header">
    			<thead>
        		<tr>
           	   		<td align="center" colspan="6"><strong>Image Carusel Data</strong></td>
	        	</tr>
        		<tr>
            		<th>NO</th>
	            	<th>IMAGE INDEX</th>
        		...
        		?>
            		    ...
            		    <tr>
    		                ...
    		                <td>
    		                	<?php 
    		                		if($d->flag==0) echo "Inactive"; 
    		                		else echo "<strong>Active</strong>"; 
    		                	?>
    		                </td>
    		                <td>
