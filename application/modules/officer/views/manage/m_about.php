...
<ul class="nav nav-tabs">
  <li role="presentation"><a href="<?php echo base_url();?>officer/manage/img_carusel">Manage Carusel</a></li>  
<!--
...
-->
  ...
  <li role="presentation" class="active"><a href="#">About Us Manage</a></li>
</ul>
<div class="container sub">
	...
	<div id="form_List">
			<table class="table table-bordered table-striped table-fixed-header">
    			<thead>
        		<tr>
           	   		<td align="center" colspan="4"><strong>About Us Data</strong></td>
	        	</tr>
        		<tr>
            		<th>NO</th>
    	    	    <th>UPLOAD DATE</th>
