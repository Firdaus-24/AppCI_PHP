		...
		<script>
			...
			//})
				...
				//});
							...
							<link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/rgp.css" />
							<link rel="stylesheet" href="<?php echo base_url(); ?>assets/rgp/js/jquery.autocomplete.css" />
							<script type="text/javascript" src="<?php echo base_url(); ?>assets/rgp/js/jquery.autocomplete.js"></script>  
														<script type="text/javascript" src="<?php echo base_url(); ?>assets/rgp/jquery-1.8.3.min.js"></script>  
	...
	<body>
		<div class="navbar">
			<div class="navbar-inner">
				<div class="container-fluid">
					<a href="#" class="brand">
						<small>
							Integrated System Of PT.SUMBER MANIKO UTAMA
						</small>
					</a><!--/.brand-->

				<?php if($this->session->userdata('officer')){require_once('tpl_navbar.php');} ?>
		...
		<div class="main-container container-fluid">
			...
			<div class="sidebar" id="sidebar">
				...
				<?php if($this->session->userdata('officer')){require_once('themes/tpl_navteacher.php'); }?>
