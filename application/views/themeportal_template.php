...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo base_url().'application/assets/template/css/demo.css'; ?>" />
	<link rel="stylesheet" type="text/css" href="<?php echo base_url().'application/assets/template/css/component.css'; ?>" />
	<script src="<?php echo base_url().'application/assets/template/js/modernizr-custom.js'; ?>"></script>
</head>
...
<body>
	...
	<div class="pages-stack">
		...
		<div class="page" id="page-home">
			...
			<header class="bp-header cf">
				...
				<h1 class="bp-header__title"><?php echo $contents; ?></h1>
			...
			<!--<img class="poster" src="application/assets/template/images/1.jpg" alt="img01" />-->
		</div>
		<!-- /page -->
		<div class="page" id="page-docu">
			...
			<img class="poster" src="application/assets/template/images/6.jpg" alt="img06" />
		</div>
		<div class="page" id="page-manuals">
			...
			<img class="poster" src="application/assets/template/images/2.jpg" alt="img02" />
		</div>
		<div class="page" id="page-software">
			...
			<img class="poster" src="application/assets/template/images/3.jpg" alt="img03" />
		</div>
		<div class="page" id="page-custom">
			...
			<img class="poster" src="application/assets/template/images/4.jpg" alt="img04" />
		</div>
		<div class="page" id="page-training">
			...
			<img class="poster" src="application/assets/template/images/5.jpg" alt="img05" />
		</div>
	...
	<script src="application/assets/template/js/classie.js"></script>
	<script src="application/assets/template/js/main.js"></script>

	<a href="<?php echo base_url().'portal/Portal'; ?>"><button class="btn btn-primary">Isi Data</button></a>

	<a href="<?php echo base_url().'portal/Daftar'; ?>"><button class="btn btn-info">Lihat Data</button></a>
