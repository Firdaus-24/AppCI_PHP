...
<?php
   ...
   //echo $controller;
   $sql1 ="SELECT * from tbl_menu WHERE menu_uri='$controller' and menu_cat='3'";
   $menus = $this->db->query($sql1);
        ...
        $sql ="SELECT * from tbl_menu WHERE menu_cat='3'";
        ...
        <li class="<?php echo $class; ?>">
            <a href="<?php echo base_url().'student/'.$menu['menu_uri']?>" class="<?php echo $toggle; ?>">
